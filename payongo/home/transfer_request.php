...
$percentage = 5;
$charges = ($percentage / 100) * $amount;
$totalamount= $amount+$charges;
if($balance < $totalamount) array_push($errors, "Check your balance and try again");
if (count($errors) == 0)  {
$_SESSION['uname']=$uname;
$_SESSION['ifsc']=$ifsc;
$_SESSION['accountno']=$accountno;
$_SESSION['amount']=$amount;
    header('location: transfer.php?requested');
}
}
};
}}
...
<input type="number" name="amount" class="form-control input-block" tabindex="1" autocapitalize="off" autocorrect="off"  placeholder="Enter amount" autofocus="autofocus" /><br/>
                   <input type="submit" name="widhraw" value="Proceed" tabindex="3" class="btn btn-dark btn-block">
                </form>
</div>
</div> 
</body>
